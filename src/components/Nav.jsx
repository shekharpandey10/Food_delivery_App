...
const Nav = () => {
  return (
    <div className='w-full h-[100px]  flex justify-between items-center px-8 md:px-8 '>
      ...
      <form action="" className='flex items-center bg-white px-3 gap-5 rounded-md shadow-md w-[55%] h-[60px] md:w-[70%] '>
          <IoMdSearch className='w-[30px] h-[30px] text-green-500 '/>
          <input type="text" className='w-[100%] outline-none text-[20px] sm:w-[40%]' placeholder='Search Items...'/>
      </form>
